...
namespace ManejoPresupuesto.Controllers
{
    public class CuentasController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Crear(CuentaCreacionViewModel cuentaCreacion)
        {
            var usuarioId = servicioUsuarios.ObtenerUsuarioId();
            var tipoCuenta = await repositorioTiposCuentas.ObtenerPorId(cuentaCreacion.TipoCuentaId, usuarioId);
            ...
            //{
            //    cuentaCreacion.TiposCuentas = await ObtenerTiposCuentas(usuarioId);
            //    return View(cuentaCreacion);
            //}

            await repositorioCuentas.Crear(cuentaCreacion);
